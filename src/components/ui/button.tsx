...
const buttonVariants = cva(
  'inline-flex items-center justify-center tracking-normal font-bold rounded-[4px] w-fit h-fit transition-colors cursor-pointer disabled:cursor-not-allowed gap-1',
  {
    variants: {
      variant: {
        primary:
