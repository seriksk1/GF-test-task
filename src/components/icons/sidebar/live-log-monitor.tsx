...
export function LiveLogMonitorIcon({
  className,
  stroke = '#384250',
  ...props
}: DefaultIconProps) {
  return (
    ...
    >
      ...
      />
      <path d="M7 20H17" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 16V20" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M15 16V20"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M9 12V8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M12 12V11"
        strokeWidth="1.5"
        strokeLinecap="round"
